#!/usr/bin/env python3
"""Read-only identity checks for the SD-BEG-070-T01 MySQL lab."""
...
VOLUMES = (
    "sd-beg-070-t01-source-mysql-8-4",
    "sd-beg-070-t01-replica-mysql-8-4",
)
COMPOSE = [
    "docker",
    "compose",
...
def main() -> int:
    evidence: dict[str, object] = {
        ...
        "expected_database": "sd_beg_070_t01",
        "expected_volumes": list(VOLUMES),
        "reset_target": "sd_beg_070_t01.items through source only",
        "recovery": "start only project sd-beg-070-t01 services source and replica",
    }
